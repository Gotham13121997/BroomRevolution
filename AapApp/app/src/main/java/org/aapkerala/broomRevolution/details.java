...
public class details extends AppCompatActivity {
    //for showing details of the person
    ...
    String editable="NO";
    String s="";
    //for blocking theese characters
   ...
   //for converting string into resource
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       call.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               //on call button click making call
        ...
        la.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                //showing the pc according to the number of respective lac
                if (num <= 7) {
                ...
                //removing the "all" option from string array and making an adapter out of it
        ...
        send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //on send button click sending data to firebase database
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        //for requesting permission from user to make call
        switch (requestCode) {
            case 1:
            {
    ...
    {  //making call
        //taking the last 10 digits of no
        //and adding +91 to it to make it suitable for calling
