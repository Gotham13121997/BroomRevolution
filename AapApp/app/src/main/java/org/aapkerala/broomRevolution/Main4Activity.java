...
public class Main4Activity extends AppCompatActivity {
    ...
    //For blocking the following character set during input
    ...
    //For converting string into array resource
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //variables for respective fields
        ...
        if(as!=null&&!as.equals("phone")) {
            //If the user is not logged in as calling volunteer
            //set visiblity of delete button to gone
            //expand the send button to cover the whole screen
        ...
        //Setting the array adapter for district drop down
        ...
        //Showing dropdown of different fields on touch
        ...
        dist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                // on selecting something from district drop down
                ...
                pan_mu.setAdapter(null);
                if (!sel.equals("")) {
                    //get array adapter according to selected district
                    // by converting string into resource
                    //and creating array adapter from that resource
        ...
        la.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                //Getting the no of lac from the array
                //Assigning the PC in which The lac belongs according to that number
                if (num <= 7) {
                ...
                //If there is space in between the name converting the space to underscore
                ...
                {
                    //for chalakudy changing it to chalakudy2 as pc and lac have same name
                    //but different string array
                    sel=sel.substring(ind+2);
                ...
                //Removing the  "ALL" selection from string array
                // Then making an array adapter
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    if(phonenum.matches("[0-9]+")) {
                        //Sending the values to firebase database
                        ...
                        //Deleting no from sqlite database after sending
                        ...
                        //For returning back to the respective login page
                        String as = pref.getString("as", null);
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //On delete button click delete the number from sqlite databse
                String phonenum=phone.getText().toString();
                SQLiteDatabase db = mHelper.getWritableDatabase();
                db.delete(TaskContract.TaskEntry.TABLE,
                        TaskContract.TaskEntry.NUMBER + " = ?",
