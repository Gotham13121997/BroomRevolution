...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // registerForContextMenu(textView);
        ...
        // Shared preference variable for the entire app
        // keeps the login information in memory even after app has been closed
       ...
       if(loggedin)
        {
            ...
            if(as!= null && as.equals("pc")){
               ...
               Intent intent=new Intent(this,Pc.class);
                ...
                //If logged in as sector observer
            ...
            {
                //If logged in as ground volunteer
            ...
            {
                //If logged in as calling volunteer
           ...
           startActivity(intent);
                ...
                //If logged in as admin and selected observers
           Intent intent=new Intent(this,observers.class);
           startActivity(intent);
                finish();
       } else if(as!= null && as.equals("look_up")){
                //If logged in as admin and selected members
      ...
      //If the user was not logged in previously show login option...............................
        ...
        //Array adapter for drop down menu for login
        ...
        loginbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(loginedit.getText().toString().equals("HUGGAMA"))
                {
                    ...
                    try {
                        //Login selection as PC observer
                        //Going to firebase database and matching the credentials
                            ...
                            public void onDataChange(DataSnapshot snapshot) {
                                ...
                                for (DataSnapshot messageSnapshot : snapshot.getChildren()) {
                                    if (messageSnapshot.child("PASSWORD").getValue().toString().equals(passedit.getText().toString())) {
                                        //matched
                                        //Save the login information for the next time user opens the app
