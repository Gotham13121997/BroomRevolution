...
public class ground_volunteer_form2 extends AppCompatActivity {
    //ground volunteer form second page
    private Button next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //sending data to firebase database on pressing next button
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.exists()) {
                        for (DataSnapshot messageSnapshot : dataSnapshot.getChildren()) {
                            //getting data from firebase database if already stored
